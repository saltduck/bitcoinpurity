...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-checkforbroadcasts", strprintf("Enable the GUI official broadcast notice checker (default: %u)", DEFAULT_CHECKFORBROADCASTS), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-broadcastsmanifest=<url>", "Override the signed official broadcasts manifest URL used by the GUI (default: https://downloads.bitcoinpurity.org/broadcasts.json).", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
